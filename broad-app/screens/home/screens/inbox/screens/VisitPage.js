      ...
      <SafeAreaView style={styles.safeContainer}>
        <View style={styles.foregroundContainer}>
          <View style={styles.pageHeaderContainer}>
            <FontAwesome name='angle-left' size={35} color={colors.blue} style={{position:'absolute', zIndex:1, left:25, top:25}} onPress={()=>navigation.goBack()}/>
            <Image source={{uri:'https://placeimg.com/640/480/any'}} style={styles.profileImage}/>
            <Text style={styles.headerText}>{username}</Text>
            <View style={styles.userActionsContainer}>
              <TouchableOpacity style={styles.userActionsButton} onPress={()=>setFollowing(!following)}>
                <Text style={{color:colors.white, fontWeight:'500'}}>{following ? 'Takibi Bırak' : 'Takip Et'}</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.userActionsButton}>
                <Text style={{color:colors.white, fontWeight:'500'}}>Mesaj At</Text>
              </TouchableOpacity>
            </View>
